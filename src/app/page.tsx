...
const LocationMap = dynamic(
  ...
  { ssr: false, loading: () => <div className="h-full min-h-[300px] animate-pulse rounded-lg bg-gray-200" /> }
);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-sky-100">
      <div className="mx-auto max-w-6xl px-4 py-8">
        <header className="mb-8 text-center">
          <h1 className="mb-2 text-4xl font-bold text-gray-800">Weather Compare</h1>
        ...
        <div className="mb-8 grid gap-6 lg:grid-cols-5">
          ...
          <div className="rounded-xl bg-white p-6 shadow-md lg:col-span-2">
            ...
            <div className="mt-6 flex justify-center">
              <button
                ...
                disabled={!canCompare}
                className="w-full rounded-lg bg-blue-600 px-8 py-3 font-semibold text-white transition-colors hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:bg-gray-400"
              >
          ...
          {/* Map - wider */}
          <div className="rounded-xl bg-white p-4 shadow-md lg:col-span-3">
